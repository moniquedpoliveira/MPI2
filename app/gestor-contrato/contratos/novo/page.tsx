  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const contratoData = {
        ...
        modalidadeLicitacao: formData.modalidadeLicitacao || "",
        objeto: formData.objeto || "",
        orgaoContratante: formData.orgaoContratante || "",
        nomeContratada: formData.nomeContratada || "",
        cnpjContratada: formData.cnpjContratada || "",
        representanteLegal: formData.representanteLegal || "",
        enderecoContratada: formData.enderecoContratada || "",
        telefoneContratada: formData.telefoneContratada || "",
        emailContratada: formData.emailContratada || "",
        valorTotal: formData.valorTotal || 0,
        dataAssinatura: formData.dataAssinatura as Date,
        vigenciaInicio: formData.vigenciaInicio as Date,
        vigenciaTermino: formData.vigenciaTermino as Date,
        dataBaseReajuste: formData.dataBaseReajuste,
        indiceReajuste: formData.indiceReajuste || "",
        tipoGarantia: formData.tipoGarantia || "",
        valorGarantia: formData.valorGarantia || 0,
        vigenciaGarantia: formData.vigenciaGarantia,
        gestorContrato: formData.gestorContrato || "",
        portariaGestor: formData.portariaGestor || "",
        emailGestor: formData.emailGestor || "",
        telefoneGestor: formData.telefoneGestor || "",

        // New fiscal ID fields
        fiscalAdministrativoId: formData.fiscalAdministrativoId || null,
        fiscalTecnicoId: formData.fiscalTecnicoId || null,
        fiscalSubstitutoId: formData.fiscalSubstitutoId || null,

        // Legacy fiscal fields for backward compatibility
        fiscalAdministrativoLegacy: formData.fiscalAdministrativoLegacy || "",
        fiscalTecnicoLegacy: formData.fiscalTecnicoLegacy || "",
        fiscalSubstitutoLegacy: formData.fiscalSubstitutoLegacy || "",

        portariaFiscalAdm: formData.portariaFiscalAdm || "",
        emailFiscalAdm: formData.emailFiscalAdm || "",
        telefoneFiscalAdm: formData.telefoneFiscalAdm || "",
        portariaFiscalTec: formData.portariaFiscalTec || "",
        emailFiscalTec: formData.emailFiscalTec || "",
        telefoneFiscalTec: formData.telefoneFiscalTec || "",
        portariaFiscalSub: formData.portariaFiscalSub || "",
        emailFiscalSub: formData.emailFiscalSub || "",
        sancaoAdministrativa: formData.sancaoAdministrativa || "Nenhuma",
      };
  ...
  return (
    <div className="flex flex-col">
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        <div>
          <h1 className="font-semibold text-lg">Novo Contrato</h1>
